...
local function loadcheat()
    ...
    CreateClientConVar("c_active", "1", true, false, "salut mon pote")
    CreateClientConVar("c_chams", "1", true, false, "salut mon pote")
    CreateClientConVar("c_chams_players", "1", true, false, "salut mon pote")
    CreateClientConVar("c_chams_loot", "1", true, false, "salut mon pote")
    CreateClientConVar("c_chams_door", "0", true, false, "salut mon pote")
    CreateClientConVar("c_chams_physbox", "0", true, false, "salut mon pote")
    CreateClientConVar("c_chams_button", "0", true, false, "salut mon pote")
    CreateClientConVar("c_chams_body", "0", true, false, "salut mon pote")
    CreateClientConVar("c_chams_gun", "1", true, false, "salut mon pote")
    CreateClientConVar("c_chams_knife", "1", true, false, "salut mon pote")
    CreateClientConVar("c_chams_boxes", "0", true, false, "salut mon pote")
    CreateClientConVar("c_esp", "1", true, false, "salut mon pote")
    CreateClientConVar("c_esp_realname", "0", true, false, "salut mon pote")
    CreateClientConVar("c_esp_murdername", "1", true, false, "salut mon pote")
    CreateClientConVar("c_esp_loot", "1", true, false, "salut mon pote")
    CreateClientConVar("c_esp_role", "1", true, false, "salut mon pote")
    CreateClientConVar("c_esp_pistol", "1", true, false, "salut mon pote")
    CreateClientConVar("c_esp_knife", "1", true, false, "salut mon pote")
    CreateClientConVar("c_misc_aimbot", "0", true, false, "salut mon pote")
    CreateClientConVar("c_misc_snapline", "0", true, false, "salut mon pote")
    CreateClientConVar("c_misc_fullbright", "0", true, false, "salut mon pote")
    CreateClientConVar("c_chams_murdercolor", "255 0 0 127", true, false, "salut mon pote")
    CreateClientConVar("c_chams_bystandercolor", "0 255 0 127", true, false, "salut mon pote")
    CreateClientConVar("c_chams_gunnercolor", "0 0 255 127", true, false, "salut mon pote")
    CreateClientConVar("c_chams_lootcolor", "255 255 0 255", true, false, "salut mon pote")
    CreateClientConVar("c_chams_doorcolor", "255 111 0 127", true, false, "salut mon pote")
    CreateClientConVar("c_chams_bodycolor", "255 0 0 127", true, false, "salut mon pote")
    CreateClientConVar("c_chams_guncolor", "33 0 255 158", true, false, "salut mon pote")
    CreateClientConVar("c_chams_knifecolor", "255 0 0 147", true, false, "salut mon pote")
    CreateClientConVar("c_chams_mappropcolor", "8 0 255 59", true, false, "salut mon pote")
    CreateClientConVar("c_chams_mapbuttoncolor", "8 0 255 59", true, false, "salut mon pote")
    CreateClientConVar("c_esp_lootcolor", "0 255 135 255", true, false, "salut mon potez")
    CreateClientConVar("c_esp_realnamecolor", "255 255 255 255", true, false, "salut mon pote")
    CreateClientConVar("c_esp_bystandernamecolor", "255 255 255 255", true, false, "salut mon pote")
    CreateClientConVar("c_esp_knifecolor", "255 0 0 255", true, false, "salut mon pote")
    CreateClientConVar("c_esp_guncolor", "0 0 255 255", true, false, "salut mon pote")--c_misc_autoshoot
    CreateClientConVar("c_misc_autoshoot", "0", true, false, "salut mon pote")
    ------------------------------------------- Color convar
    local test = [[
